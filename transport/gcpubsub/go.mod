module github.com/tx7do/kratos-transport/transport/gcpubsub

go 1.25.0

replace (
	github.com/tx7do/kratos-transport/broker => ../../broker
	github.com/tx7do/kratos-transport/broker/gcpubsub => ../../broker/gcpubsub
...
require (
	...
	github.com/tx7do/kratos-transport/broker/gcpubsub v1.4.1
