module github.com/tx7do/kratos-transport/transport/azuresb

go 1.25.0

replace (
	github.com/tx7do/kratos-transport/broker => ../../broker
	github.com/tx7do/kratos-transport/broker/azuresb => ../../broker/azuresb
...
require (
	...
	github.com/tx7do/kratos-transport/broker/azuresb v1.4.1
