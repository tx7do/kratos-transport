module github.com/tx7do/kratos-transport/transport/sqs

go 1.25.0

replace (
	github.com/tx7do/kratos-transport/broker => ../../broker
	github.com/tx7do/kratos-transport/broker/sqs => ../../broker/sqs
...
require (
	...
	github.com/tx7do/kratos-transport/broker/sqs v1.4.1
