...
require (
	...
	github.com/tx7do/kratos-transport/transport/kafka v0.0.0-20230907043132-020df549da17
)
...
require (
	...
	github.com/tx7do/kratos-transport/broker/kafka v0.0.0-20230907043132-020df549da17 // indirect
