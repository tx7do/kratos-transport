...
require (
	...
	github.com/tx7do/kratos-transport/transport/kafka v1.2.26
)
...
require (
	...
	github.com/tx7do/kratos-transport/broker/kafka v1.2.23 // indirect
	github.com/tx7do/kratos-transport/transport/keepalive v1.0.8 // indirect
