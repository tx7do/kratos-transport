...
require (
	...
	github.com/tx7do/kratos-transport/transport/kafka v0.0.0-20230907094842-7bd2c46dbb2b
)
...
require (
	...
	github.com/tx7do/kratos-transport/broker/kafka v0.0.0-20231024140845-2532526c9f77 // indirect
