...
require (
	...
	github.com/tx7do/kratos-transport/transport/kafka v0.0.0-20230814135856-d0623a4a6ac1
)
...
require (
	...
	github.com/tx7do/kratos-transport/broker/kafka v0.0.0-20230814135856-d0623a4a6ac1 // indirect
