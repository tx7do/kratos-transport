...
require (
	...
	github.com/tx7do/kratos-transport/transport/kafka v0.0.0-20230907061843-be73df6a2ace
)
...
require (
	...
	github.com/tx7do/kratos-transport/broker/kafka v0.0.0-20230907061843-be73df6a2ace // indirect
