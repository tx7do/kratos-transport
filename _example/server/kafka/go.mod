...
require (
	...
	github.com/tx7do/kratos-transport/transport/kafka v0.0.0-20230907012452-5735b00ff418
)
...
require (
	...
	github.com/tx7do/kratos-transport/broker/kafka v0.0.0-20230907012452-5735b00ff418 // indirect
