...
require (
	...
	github.com/tx7do/kratos-transport/transport/mqtt v0.0.0-20230907094248-a7d8999b8137
)
...
require (
	...
	github.com/tx7do/kratos-transport/broker/mqtt v0.0.0-20230907094248-a7d8999b8137 // indirect
