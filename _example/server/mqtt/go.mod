...
require (
	...
	github.com/tx7do/kratos-transport/transport/mqtt v0.0.0-20230907091654-32334115fdef
)
...
require (
	...
	github.com/tx7do/kratos-transport/broker/mqtt v0.0.0-20230907091654-32334115fdef // indirect
