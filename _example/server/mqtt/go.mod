...
require (
	...
	github.com/tx7do/kratos-transport/transport/mqtt v0.0.0-20230907094842-7bd2c46dbb2b
)
...
require (
	...
	github.com/tx7do/kratos-transport/broker/mqtt v0.0.0-20231023135736-ba9d01de7a74 // indirect
