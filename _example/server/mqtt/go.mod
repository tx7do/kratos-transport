...
require (
	...
	github.com/tx7do/kratos-transport/transport/mqtt v0.0.0-20230907063631-6abe3f39250f
)
...
require (
	...
	github.com/tx7do/kratos-transport/broker/mqtt v0.0.0-20230907063631-6abe3f39250f // indirect
