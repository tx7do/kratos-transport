...
require (
	...
	github.com/tx7do/kratos-transport/transport/mqtt v0.0.0-20230907040118-36ce08db1af0
)
...
require (
	...
	github.com/tx7do/kratos-transport/broker/mqtt v0.0.0-20230907040118-36ce08db1af0 // indirect
