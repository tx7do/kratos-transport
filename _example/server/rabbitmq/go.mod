...
require (
	...
	github.com/tx7do/kratos-transport/broker/rabbitmq v0.0.0-20231023130745-950cc10f23e0
	github.com/tx7do/kratos-transport/transport/rabbitmq v0.0.0-20230907094842-7bd2c46dbb2b
)
