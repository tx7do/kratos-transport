...
require (
	...
	github.com/tx7do/kratos-transport/broker/rabbitmq v0.0.0-20230907061843-be73df6a2ace
	github.com/tx7do/kratos-transport/transport/rabbitmq v0.0.0-20230907061843-be73df6a2ace
)
