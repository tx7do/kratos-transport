...
require (
	...
	github.com/tx7do/kratos-transport/broker/rabbitmq v0.0.0-20230907094248-a7d8999b8137
	github.com/tx7do/kratos-transport/transport/rabbitmq v0.0.0-20230907094248-a7d8999b8137
)
