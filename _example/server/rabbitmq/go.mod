...
require (
	...
	github.com/tx7do/kratos-transport/broker/rabbitmq v0.0.0-20230907063631-6abe3f39250f
	github.com/tx7do/kratos-transport/transport/rabbitmq v0.0.0-20230907063631-6abe3f39250f
)
