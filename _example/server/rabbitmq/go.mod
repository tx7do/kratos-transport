...
require (
	...
	github.com/tx7do/kratos-transport/broker/rabbitmq v0.0.0-20230907054419-eb7902c7c670
	github.com/tx7do/kratos-transport/transport/rabbitmq v0.0.0-20230907054419-eb7902c7c670
)
